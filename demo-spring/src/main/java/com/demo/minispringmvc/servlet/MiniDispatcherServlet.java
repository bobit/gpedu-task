package com.demo.minispringmvc.servlet;
...
/**
 * 重写init方法、doGet、doPost方法，以及我们要实现的功能
 *
 * @Author: zhangb
 * @Date: 2019-03-24 15:50
 */
...
//        out.println("hello zhangsan");
    ...
    private void doInstance() {
        ...
        for (String className : classNames) {
            try {
                //把类搞出来,反射来实例化(只有加@MiniController需要实例化)
        ...
        try {
            for (Map.Entry<String, Object> entry : ioc.entrySet()) {
                ...
                for (Method method : methods) {
                    ...
                    MiniRequestMapping annotation = method.getAnnotation(MiniRequestMapping.class);
